            ...
            <form>
                <div class=" space-y-6 sm:space-y-5">
                    <div
                        ...
                        <label for="name" class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-2">Name</label>
                    ...
                    <div
                        ...
                        <label for="shortDescription"
                            class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-2">Kurzbeschreibung</label>
                        <div class="mt-1 sm:col-span-2 sm:mt-0">
                    ...
                    <div
                        class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-5 sm:pl-6 sm:border-t sm:border-gray-200">
                        <label for="priceInEuro" class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-2">Preis
                            in Euro</label>
                        <div class="mt-1 sm:col-span-2 sm:mt-0">
                    ...
                    <div
                        class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-5 sm:pl-6 sm:border-t sm:border-gray-200">
                        <label for="category"
                            class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-2">Kategorie</label>
                        <div class="mt-1 sm:col-span-2 sm:mt-0">
                    ...
                    <div
                        ...
                        <label for="dietCategories"
                            class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-2">Ernährungsform</label>
                    ...
                    <div
                        class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-5 sm:pl-6 sm:border-t sm:border-gray-200">
                        <label for="dietCategories"
                            class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-2">Mahlzeiten</label>
                        <fieldset class="mt-1 sm:col-span-2 sm:mt-0 grid grid-cols-2 gap-x-5 gap-y-2">
                    ...
                    <div
                        ...
                        <label for="dayCategories"
                            class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-2">Erhältlich</label>
                        <fieldset class="mt-1 sm:col-span-2 sm:mt-0 grid grid-cols-2 gap-x-5 gap-y-2">
                    ...
                    <div
                        ...
                        <label for="preparationTimeInMinutes"
                            class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-2">Zubereitungszeit in
                            Minuten</label>
                        <div class="mt-1 sm:col-span-2 sm:mt-0">
                    ...
                    <div
                        class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-5 sm:pl-6 sm:border-t sm:border-gray-200">
                        <label for="dietCategories"
                            class="block text-sm font-medium text-gray-500 sm:mt-px sm:pt-1">Status</label>
                        <fieldset class="mt-1 sm:col-span-2 sm:mt-0 grid grid-cols-2 gap-x-5 gap-y-2">
